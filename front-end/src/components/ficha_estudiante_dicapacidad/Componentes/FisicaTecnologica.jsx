                    ...
                    },
                    {
                      ...
                      content: (
                        <Columns
                          columns={[
                            [
                                { type: "text", name: "Accesibilidad básica de los sistemas hadware y sotfware" },
                                { type: "radio",  name: "oneChoice", value: "Comandos de funcionamiento básico"},
                            ],
                            [
                                { type: "text", name: "Accesibilidad Intermedia al software para los procesos académicos" },
                                { type: "radio", name: "quadrupleChoice", value: "Paquete Office"},
                                { type: "radio", name: "quadrupleChoice", value: "Exploradores Web"},
                                { type: "radio", name: "quadrupleChoice", value: "Correo Electrónico"},
                                { type: "radio", name: "quadrupleChoice", value: "Drive"},
                            ],    
                            [
                                { type: "text", name: "Accesibilidad avanzada al software según la carrera" },
                                { type: "radio", name: "quintupleChoice", value: "Adobe Illustrator"},
                                { type: "radio", name: "quintupleChoice", value: "Adobe Photoshop"},
                                { type: "radio", name: "quintupleChoice", value: "R Studio"},
                                { type: "radio", name: "quintupleChoice", value: "Stata"},
                                { type: "radio", name: "quintupleChoice", value: "Spss Statistics"},
                            ],
                          ]}
                        />
                      ),
              ...
              content: (
                <AcordionesHijos
                  acordiones={[
                      ...
                      content: (
                        <Columns
                          columns={[
                            ...
                            [
                                { type: "checkbox", name: " Espacios recreativos, sociales y culturales" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                            [
                                { type: "checkbox", name: " Usos de equipamientos urbanos" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                            [
                                { type: "checkbox", name: " Uso de elementos de señalización" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                            [
                            ...
                            [
                                { type: "checkbox", name: " A nivel Tecnológico la Experiencia y conocimiento del manejo de las herramientas tecnológicas" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                          ]}
                    ...
                    },
                    {
                      ...
                      content: (
                        <Columns
                          columns={[
                            [
                                { type: "checkbox", name: " Abarca el cuidado de uno mismo" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                            [
                                { type: "checkbox", name: " Lavarse y secarse a sí mismo" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                            [
                                { type: "checkbox", name: " El cuidado del cuerpo y partes del cuerpo" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                            [
                    ...
                    { title: "Entorno físico-arquitectónico", content: (
                        <Columns
                          columns={[
                            [
                                { type: "checkbox", name: " Los accesorios y dispositivos en las instalaciones sanitarias" },
                                { type: "text", name: "Intensidad" },
                                { type: "select", name: "", options: ["Intermitente", "Limitado", "Extenso", "Generalizado"] },
                            ],
                          ]}
