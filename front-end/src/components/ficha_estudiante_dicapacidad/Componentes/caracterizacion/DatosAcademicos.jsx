...
const DatosAcademicos = () => {
    ...
    const handleAddProgram = () => {
        setProgramas([...programas, { anio: "", programaAcademico: "", motivoNo: "", especificarMotivo: "" }]);
    };
        ...
        <div className="space_content">
            <div className="container_carac">
                <div className="full-width">
                    ...
                    <p>Seleccione el año de ingreso del estudiante: <input type="number" id="year" name="year" min="1990" max="2099" step="1" placeholder="Ingresa el año"/></p>
                        ...
                        <div className="programas-container">
                            {programas.map((programa, index) => (
                                <div className="programa-item" key={index}>
                                    ...
                                    <button type="button" onClick={() => handleRemoveProgram(index)}>Eliminar</button>
                                </div>
                            ))}
                        </div>
                        <button type="button" onClick={handleAddProgram}>Añadir Programa</button>
                    </div>
                </div>
            </div>
