  ...
  return (
    <Container className="mi-clase-background">
      <Row className="mt-2">
        ...
        <Col sm={9}>
          <Form.Select name="option" onChange={handle_options}>
            ...
            <option value="volver_estudiante_disc">
              Activar estudiante Discapacidad
            </option>
            <option value="quitar_estudiante_disc">
              Eliminar estudiante Discapacidad
            </option>
            <option value="asignacion_disc">Asignación Discapacidad</option>
            <option value="monitoria_academica">Monitoria Academica</option>
            <option value="desactivar_monitoria_academica">
              Desactivar Monitoria Academica
            </option>
            <option value="activar_monitoria_academica">
              Activar Monitoria Academica
            </option>
          </Form.Select>
        </Col>
      </Row>
      <Row className="mt-2">
        ...
        <a
          href="https://docs.google.com/spreadsheets/d/1NcB2BQFo5yigrm4ffls7pNoGoCi766Pe7bXbfNOwDQY/edit#gid=0"
          target="_blank"
        >
          Plantillas de Carga
        </a>
