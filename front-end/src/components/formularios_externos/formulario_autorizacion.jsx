        ...
        <Col>
          <Row>
            ...
            <p className="info-text">
              ...
              adelante ASES, es una iniciativa de la Vicerrectoría Académica de
              la Universidad del Valle, cuyas labores consisten en el
              ...
              excepción otorgadas por la ley a grupos poblacionales específicos.
              Dicho trabajo, tiene el objetivo de contribuir al desarrollo
              personal y académico de los estudiantes y a la reducción de su
              riesgo de deserción universitaria. Para el desarrollo de sus
              labores, ASES recopila y almacena información personal y sensible
              de los estudiantes.
            </p>
            ...
            <p className="info-text">
              En cumplimiento a nuestro deber de informar tal como lo dispone la
              Ley 1581 de 2012, la Universidad del Valle, le informa que los
              datos personales y sensibles recolectados, serán utilizados
              únicamente con fines (de contacto, para la planeación y ejecución
              de las actividades de seguimiento y acompañamiento, para la
              elaboración de material informativo y publicitario y para
              propósitos de investigación. Además, podrán ser compartidos con
              otras dependencias de la Universidad para fines estadísticos o con
              cualquier dependencia que lo llegase a solicitar con ajuste a la
              ley), y tratados conforme la política de tratamiento de datos
              personales de la Universidad del Valle, publicada en la página
              web:{" "}
            ...
            <p className="info-text-item">
              - Se tomarán fotografías y videos que podrán usarse en el material
              publicitario, informativo, didáctico, página web, redes sociales
              institucionales y otros medios de difusión de ASES.
            </p>
            <p className="info-text-item">
              - Se llevará a cabo el registro de datos personales, sensibles e
              información del acompañamiento en las bases de datos resultado del
              ejercicio de acompañamiento, es decir, información en las cinco
              dimensiones del riesgo de deserción a saber: Individual,
              Económica, Familiar, Académica y, Vida universitaria y ciudad, de
              tipo académico, familiar, personal y datos relacionados con su
              ámbito económico.
            </p>
            <p className="info-text">
            ...
            <p className="info-text">
              ...
              investigativos, académicos y de difusión. La autorización del uso
              de datos e imágenes no representa una retribución monetaria para
              usted como estudiante, dado el carácter académico del uso de los
              datos.
            </p>

            <p className="info-text">
              Para ejercer su derecho de conocer, actualizar o rectificar la
              información puede contactarnos a través de los siguientes canales:
            </p>
