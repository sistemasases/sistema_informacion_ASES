...
*/
  ...
  const handle_upload_estudiante = (e) => {
    ...
    formData.append(
      "fecha_nac",
      state.nuevo_fecha_nac !== null ? state.nuevo_fecha_nac : [null]
    );
    ...
    axios({
      ...
      .then((res) => {
        set_state({
          ...
          fecha_nac: state.nuevo_fecha_nac,
        ...
        <Row>
          <Col xs={"12"}>
            <Row>
              ...
              <Col xs={"12"} md={"3"} className="row_flex_general">
                <h4 className="texto_pequeño_gris">Fecha de Nacimiento</h4>
              </Col>
              {state.editar ? (
                <Col xs={"12"} md={"3"} className="row_flex_general">
                  <input
                    type="date"
                    name="nuevo_fecha_nac"
                    defaultValue={state.fecha_nac}
                    onChange={cambiar_datos}
                  ></input>
                </Col>
              ) : (
                <Col xs={"12"} md={"3"} className="row_flex_general">
                  <h4 className="texto_pequeño_12pt">{nac_date_to_edit}</h4>
                </Col>
              )}
