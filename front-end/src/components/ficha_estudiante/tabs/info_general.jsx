/**
 * @file informacion_general.jsx
 * @version 1.0.0
 * @description Muestra la información general del estudiante.
...
import {
  ...
  desencriptarIdEstudianteSeleccionado,
  desencriptarInt,
...
const Info_general = (props) => {
  ...
  /**
   * @description Función que hace la petición de grupos etnicos.
  ...
  const opciones_lista_Etico = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/usuario_rol/grupos_etnicos/`,
        config
      )
      .then((response) => {
  ...
  /**
   * @description Función que hace la petición de actividad simultánea.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  const opciones_lista_Actividad_simultanea = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/usuario_rol/actividad_simultanea/`,
        config
      )
      .then((response) => {
        const grupos = response.data;
  ...
  /**
   * @description Función que hace la petición de identidad de género.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  const opciones_lista_identidad_de_genero = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/usuario_rol/identidad_gen/`,
        config
      )
      .then((response) => {
        const grupos = response.data;
  ...
  /**
   * @description Función que hace la petición del estado civil.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  ...
  /**
   * @description Función que hace la petición de la condición de excepción.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  const opciones_lista_condicion_de_excepcion = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/usuario_rol/condicion_de_excepcion/`,
        config
      )
      .then((response) => {
        const grupos = response.data;
  ...
  /**
   * @description Función que actualiza la data.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  ...
  /**
   * @description Función que hace cancela ciertas inserciones de la data.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
...
*/
  /**
   * @description Función que agrega parientes.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  const agregarPariente = () => {
  ...
  /**
   * @description Función que guarda parientes.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  ...
  /**
   * @description Función que cancela parientes.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
...
*/
  ...
  const cambiar_datos = (e) => {
    if (e.target.name.startsWith("nuevo_personas_con_quien_vive")) {
      ...
      set_state((prevState) => {
        const nuevoPersonasConQuienVive = {
          personas: [
            ...(prevState.nuevo_personas_con_quien_vive &&
  ...
  /**
   * @description Función que procesa los datos del form.
   * @param {} - No recibe parámetros.
   * @return {void} - No retorna ningún valor.
   */
  const handle_upload_estudiante = (e) => {
    ...
    // Almacena una instancia de FormData.
    let formData = new FormData();
    formData.append(
      "puntaje_icfes",
      state.nuevo_puntaje_icfes !== null ? state.nuevo_puntaje_icfes : [null]
    );

    formData.append(
      "telefono_res",
      state.nuevo_telefono_res !== null &&
        state.nuevo_telefono_res !== undefined &&
        state.nuevo_telefono_res.length > 0
        ? state.nuevo_telefono_res
        : "0"
    );
    formData.append(
      "celular",
      state.nuevo_celular !== null &&
        state.nuevo_celular !== undefined &&
        state.nuevo_celular.length > 0
        ? state.nuevo_celular
        : "0"
    );
    formData.append(
    ...
    formData.append(
      "sexo",
      state.nuevo_sexo !== null &&
        state.nuevo_sexo !== undefined &&
        state.nuevo_sexo.length > 0
        ? state.nuevo_sexo
        : "sin especificar"
    );
    formData.append(
      "hijos",
      state.nuevo_cantidad_hijo !== null &&
        state.nuevo_cantidad_hijo !== undefined &&
        state.nuevo_cantidad_hijo.length > 0
        ? state.nuevo_cantidad_hijo
        : "0"
    );

    formData.append(
      "actividades_ocio_deporte",
      state.nuevo_deportes_que_practica !== null
        ? state.nuevo_deportes_que_practica
        : [null]
    );
    formData.append(
      "acudiente",
      state.nuevo_acudiente_emergencia !== null &&
        state.nuevo_acudiente_emergencia !== undefined &&
        state.nuevo_acudiente_emergencia.length > 0
        ? state.nuevo_acudiente_emergencia
        : "sin especificar"
    );
    formData.append(
      "telefono_acudiente",
      state.nuevo_tel_acudiente_emergencia !== null
        ? [state.nuevo_tel_acudiente_emergencia]
        : [null]
    );
    formData.append(
      "telefono_acudiente",
      state.nuevo_tel_acudiente_emergencia !== null &&
        state.nuevo_tel_acudiente_emergencia !== undefined &&
        state.nuevo_tel_acudiente_emergencia.length > 0
        ? state.nuevo_tel_acudiente_emergencia
        : "0"
    );
    ...
    formData.append(
      "observacion",
      state.nuevo_observaciones !== null ? [state.nuevo_observaciones] : [null]
    );
    ...
    formData.append(
      ...
      state.nuevo_actividad_simultanea !== null
        ? state.nuevo_actividad_simultanea
        : [null]
    );
    formData.append(
      "id_identidad_gen",
      state.nuevo_identidad_de_genero !== null
        ? state.nuevo_identidad_de_genero
        : [null]
    );
    formData.append(
      "id_estado_civil",
      state.nuevo_estado_civil !== null ? state.nuevo_estado_civil : [null]
    );
    formData.append(
      "id_cond_excepcion",
      state.nuevo_condicion_de_excepcion !== null
        ? state.nuevo_condicion_de_excepcion
        : [null]
    );

    formData.append(
      "vive_con",
      JSON.stringify(state.nuevo_personas_con_quien_vive) !== null
        ? JSON.stringify(state.nuevo_personas_con_quien_vive)
        : [null]
    );
    ...
    axios({
      url:
        `${process.env.REACT_APP_API_URL}/usuario_rol/estudiante_actualizacion/` +
        props.datos.id +
        "/",
      method: "POST",
      data: formData,
  ...
  return (
    <Container className="container_informacion_general" xs={"12"} sm={"6"}>
      <Col xs={"12"}>
        ...
        {state.editar ? (
          <Row>
            <Col xs={"6"} sm={"6"}>
              <Button
                className="boton_editar_info_basica"
                onClick={handle_upload_estudiante}
              >
                ACEPTAR
              </Button>
            </Col>
            <Col xs={"6"} sm={"6"}>
              <Button
                className="boton_editar_info_basica"
                onClick={esta_editando_cancelar}
              >
                CANCELAR
              </Button>
            </Col>
        ...
        <Row>
          <Col xs={"12"}>
            <Row>
              <h1 className="texto_subtitulo">
                Información del estudiante :{props.datos["nombre"]}
              </h1>
              ...
              {state.editar ? (
                <Col xs={"12"} md={"3"} className="row_flex_general"></Col>
              ) : (
                <Col xs={"12"} md={"3"} className="row_flex_general">
                  <h4 className="texto_pequeño_12pt">
                    {state.año_ingreso_univalle}
                  </h4>
                </Col>
              )}
        ...
        {state.personas_con_quien_vive !== null ? (
          <Row>
            ...
            {state.editar || state.agregarPariente ? (
              <Row>
                {state.personas_con_quien_vive.personas &&
                state.personas_con_quien_vive.personas.length > 0 ? (
                  <Row>
                    {state.nuevo_personas_con_quien_vive.personas.map(
                      (item, index) => (
                        <Row className="row_flex_general">
                    ...
                    <Col xs={"12"} className="col_adicionar_parentesco">
                      <Button
                        className="adicionar_parentesco"
                        onClick={guardarPariente}
                      >
                        Guardar
                      </Button>
                      <Button
                        className="adicionar_parentesco"
                        onClick={cancelarPariente}
                      >
                        Cancelar
                      </Button>
                    </Col>
              ...
              <Row>
                ...
                state.personas_con_quien_vive.personas.length > 0 ? (
                  <Row>
                    {state.personas_con_quien_vive.personas.map(
                      (item, index) => (
                        <Row>
            ...
            <Row className="row_flex_general">
              <Col xs={"12"} md={"6"} className="texto_pequeño_12pt">
                <input
                  ...
                  onChange={cambiar_datos}
                  defaultValue={state.nuevo_acudiente_emergencia}
                ></input>
              </Col>
              <Col xs={"12"} md={"6"} className="texto_pequeño_12pt">
                <input
                  name="nuevo_tel_acudiente_emergencia"
        ...
        {state.editar ? (
          <Row>
            ...
            <input
              ...
              onChange={cambiar_datos}
              defaultValue={state.nuevo_observaciones}
            ></input>
          </Row>
        ) : (
          <Row>
      ...
      <Modal show={show} onHide={handleClose2}>
        ...
        <Modal.Body>
          {" "}
          {state.info_modal} el : {state.ultima_actualizacion}
        </Modal.Body>
        <Modal.Footer>
