  ...
  return (
    <Row className="row_prueba">
                  ...
                  {state.seleccionado === "" ? (
                    <Row className="infoRow2">
                      <Col xs={"12"} md={"9"}>
                        ...
                        <Row>
                          <label className="info_programa_academico_egresado">
                            Egresado
                          </label>
                          <label className="info_programa_academico_en_curso">
                            En curso
                          </label>
                          <label className="info_programa_academico_desertor">
                            Desertor
                          </label>
                        </Row>
                    ...
                    <Row className="infoRow2">
                      <Col md={"9"}>
                        ...
                        {state.programas.map((item, index) => (
                        ...
                        <Row>
                          <h4 className="texto_mas_pequeño">
                            ...
                            {state.profesional.last_name}
                            <br />
                            Practicante: {state.practicante.first_name}{" "}
                            {state.practicante.last_name}
                            <br />
                            Monitor: {state.monitor.first_name}{" "}
                            {state.monitor.last_name}
                            <br />
                            Ultima actualización:{" "}
                        ...
                        <Row md={"5"}>
                          ...
                          >
                            <a
                              href="https://sistemaases.univalle.edu.co/U2FsdGVkX18hjszpddLoSgU/HywzCP8D13edFaHOV+PmxYYqsxUx7dICZxdkz/bz"
                              target="_blank"
                            >
                              <i
                  ...
                  {state.seleccionado === "" ? (
                    <Row className="info_pequeño">
                      ...
                      <Col
                        xs={"5"}
                        sm={"1"}
                        className="info_texto_cedula_pequeño"
                        md={"2"}
                      >
      ...
      <Col xs={"12"} lg={"3"} className="prueba1">
        {/* { console.log(state.total_datos_estudiantes["id"])} */}
        <Info_registros
          id_estudiante={state.total_datos_estudiantes["id"]}
        ></Info_registros>
      </Col>
