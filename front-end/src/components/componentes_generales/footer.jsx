        ...
        <Col className="container_footer">
            <div class="d-none d-md-inline">
                ...
                <Row className="footer_links_bajo">
                    ...
                    <a href="https://mail.google.com/mail/" target="_blank" rel="noonpener noreferrer">
                    sistemas.ases@correounivalle.edu.co</a>
                ...
                <Row className="footer_links_bajo">
                <a href="https://www.instagram.com/estrategia.ases/?hl=es-la" target="_blank" rel="noonpener noreferrer">
