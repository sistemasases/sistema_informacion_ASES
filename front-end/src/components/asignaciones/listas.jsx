        ...
        {props.profesional_seleccionado === "" ? (
          <Col onClick={() => childClicked(props.item.id)}>
            <Row className="asignaciones_hover1">
              <Col xs={"10"} md={"4"}>
                <Row className="nombres_asignacion">{props.item.username}</Row>
          ...
          <Col onClick={() => childClicked(props.item.id)}>
            <Row className="asignaciones_hover1">
              <Col xs={"2"} md={"2"} className="center_asignacion">
                <button
                  onClick={() => quitar_usuario()}
                  className="asignaciones_icons_quitar"
                >
                  <i class="bi bi-x"></i>
                </button>
              </Col>
        ...
        {props.practicante_seleccionado === "" ? (
          ...
          <Col onClick={() => childClicked2(props.item.id)}>
            <Row className="asignaciones_hover1">
              <Col xs={"2"} md={"2"} className="center_asignacion">
                <button
                  onClick={() => quitar_usuario_monitor()}
                  className="asignaciones_icons_quitar"
                >
                  <i class="bi bi-x"></i>
                </button>
...
*/}
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            ...
            <Col xs={"10"} md={"8"}>
              <Row>
                <Button onClick={() => quitar_estudiante()}>
                  Quitar del monitor
                </Button>
              </Row>
              <Row>
        ...
        <Modal show={show3} onHide={handleClose3}>
          ...
          <Modal.Body>Causa de retiro agregada correctamente</Modal.Body>
          <Modal.Footer>
            <Button
              variant="secondary"
              onClick={() => {
