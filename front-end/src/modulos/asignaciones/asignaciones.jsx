...
const Carga_masiva = () => {
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_API_URL}/usuario_rol/profesional/`, config)
      .then(response => {
        set_state(prevState => ({
          ...prevState,
          data1: response.data
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/usuario_rol/practicante/`, config)
      .then(response => {
        set_state(prevState => ({
          ...prevState,
          data2: response.data
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/usuario_rol/monitor/`, config)
      .then(response => {
        set_state(prevState => ({
          ...prevState,
          data3: response.data
