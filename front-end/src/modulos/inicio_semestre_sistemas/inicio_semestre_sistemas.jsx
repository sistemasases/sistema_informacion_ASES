...
const Inicio_semestre_sistemas = () => {
  ...
  return (
    <>
      {userRole.includes("view_inicio_semestre") ? (
        <Container>
          ...
          <Row className="containerRow">
            <Accordion defaultActiveKey="0" flush>
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  Paso dos: Carga masiva de los estudiantes nuevos
                </Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item eventKey="2">
                <Accordion.Header>
                  Paso tres: Carga masiva de los monitores y practicantes nuevos
                </Accordion.Header>
                <Accordion.Body>
