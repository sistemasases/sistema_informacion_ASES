        ...
        <p className="estilo_como_campus">como {desplegable}</p>
          ...
          <Col xs={"12"} md={"3"} className="botones-container-campus">
            ...
            {(userRole === 'dir_academico' )&& (
              ...
              <img src={boton15} className="boton" alt='/' onClick={() => cambiar_ruta(`/campus_diverso/descarga_campus`)}></img>)}
              {(userRole === 'CAMPUS DIVERSO' )&& (
      ...
      <Col style={{ background: "white" }} xs={"12"} md={"6"}>
        <Row>
          <Col xs={"12"} md={"5"} className="botones-container">
            ...
            {(userRole === "discapacidad" ||
              userRole === "prof_disc" ||
              userRole === "monitor_disc" ||
              userRole === "acompa_disc") && (
              <img
                src={boton9}
                className="boton"
                alt="/"
                onClick={() =>
                  cambiar_ruta(`/ficha_estudiante_discapacidad/sin_seleccion`)
                }
              ></img>
            )}
            {(userRole === "dir_academico" ||
