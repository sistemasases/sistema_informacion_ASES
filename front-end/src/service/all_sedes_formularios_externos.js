/**
 * @file all_sedes_formularios_externos.js
 * @version 1.0.0
 * @description Service para traer las sedes a los formularios externos.
 * @author @iMrStevenS2.
...
const all_sedes_formularios_externos = async () => {
  try {
    ...
    // };
    // url de la API
    const url_axios = `${process.env.REACT_APP_API_URL}/formularios_externos/enviar_sedes/`;
