...
class persona_viewsets (viewsets.ModelViewSet):
    ...
    def update(self, request, numero_documento=None): 
        persona = get_object_or_404(campus_diverso_persona, numero_documento=numero_documento)  
...
class diversidad_sexual_viewsets (viewsets.ModelViewSet):
    ...
    def retrieve(self, request, id_persona=None):
        diversidad_sexual = get_object_or_404(campus_diverso_diversidad_sexual, id_persona__numero_documento=id_persona)
    ...
    def update(self, request, id_persona=None): 
        persona = get_object_or_404(campus_diverso_persona, numero_documento=id_persona)
