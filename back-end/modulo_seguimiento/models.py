...
class seguimiento_individual (models.Model):
    ...
    objetivos= models.CharField(null=True,blank=True,max_length=5000)
    individual= models.CharField(null=True,blank=True,max_length=5000)
    ...
    familiar=models.CharField(null=True,blank=True,max_length=5000)
    riesgo_familiar=models.IntegerField(null=True)
    dinamica_familiar=models.BooleanField()
    academico=models.CharField(null=True,blank=True,max_length=5000)
    ...
    economico=models.CharField(null=True,blank=True,max_length=5000)
    ...
    vida_universitaria_ciudad=models.CharField(null=True,blank=True,max_length=5000)
    ...
    observaciones=models.CharField(null=True,blank=True,max_length=5000)
