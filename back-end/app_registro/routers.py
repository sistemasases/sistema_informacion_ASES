...
from .views import persona_viewsets, pertenencia_grupo_poblacional_viewsets, tipo_documento_viewsets, zona_residencia_viewsets, identidad_etnico_racial_viewsets,estado_civil_viewsets
